...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://safespot-backend-latest.onrender.com/auth/login",
        formData
      );
  ...
  return (
    <>
      ...
      >
        <div
          className="card shadow-lg p-4 bg-white text-center"
          style={cardStyle}
        >
          <div className="mb-3">
          ...
          <p className="text-muted mb-4">
            Sign in to your SafeSpot Lite account
          </p>
