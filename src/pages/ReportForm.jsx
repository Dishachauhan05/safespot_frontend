        ...
        <div className="p-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              <div style={fileDropZoneStyle}>
                ...
                <small className="d-block mt-2">
                  Click to upload image (JPG/PNG, up to 10MB)
                </small>
              </div>
            </div>
            ...
            <div style={contactBoxStyle}>
              ...
              <div>
                General Emergency: <strong>911</strong>
              </div>
              <div>
            ...
            <button
              type="submit"
              className="btn btn-danger w-100 mt-4 fw-semibold py-2"
            >
              Submit Emergency Report
            </button>
          </form>

          <div className="text-center text-muted small mt-3"></div>
        </div>
      </div>
    </div>
  );
